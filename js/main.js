...
$('._news-slide').owlCarousel({loop: 1, items: 4, margin: 25, dots: 1, nav: 1, navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
responsive:{
    0:{items: 2},
    600:{items: 4},
    1000:{items: 4}
...
$('.leader-cnt').owlCarousel({loop: true, margin: 70, items: 4, dots: 1, nav: 1, navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']});
$('.success-cnt').owlCarousel({loop: true, margin: 70, items: 3, dots: 1, nav: 1, navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']});
